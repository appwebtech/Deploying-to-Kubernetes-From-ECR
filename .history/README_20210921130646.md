...
I will be using a private docker repo hosted in AWS ECR and to ready the process I have build my image locally and pushed it to Amazon ECR. It's an **nginx** image packaged with a simple **index.html** file.
